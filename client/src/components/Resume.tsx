...
const Resume = () => {
  ...
  return (
    <section id="resume" className="py-20 bg-gradient-to-br from-indigo-50 via-blue-50 to-sky-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <div className="mb-8">
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">Kasuni Abeynayake - Resume</h3>
            <p className="text-muted-foreground mb-6">Complete professional profile including education, projects, skills, and achievements</p>
          </div>
